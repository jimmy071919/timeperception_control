...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\程式\\psychopy\\time_per\\con_3\\emotionmeasure_3\\emotionmeasure_lastrun.py',
...
textreproductionstart.setText('情緒估計作業\n\n請填寫SAM量表')
key_next.keys = []
key_next.rt = []
_key_next_allKeys = []
# keep track of which components have finished
estimationComponents = [textreproductionstart, key_next]
